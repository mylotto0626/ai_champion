  ...
  const features = [
    {
      icon: Brain,
      title: "AI 기반 정확한 분석",
      description: "최신 의료 AI 기술로 정확하고 신뢰할 수 있는 건강 정보를 제공합니다."
    },
    {
      icon: Clock,
      title: "24시간 언제든지",
      description: "병원이 문을 닫아도, 새벽이라도 언제든 건강 상담을 받을 수 있습니다."
    },
    {
      icon: Smartphone,
      title: "모바일 최적화",
    ...
    },
    {
      icon: Shield,
      title: "개인정보 보호",
      description: "의료정보는 철저히 보호되며, 익명 상담으로 안전하게 이용하세요."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
            왜 <span className="text-medical-primary">MedNuri</span>를 선택해야 할까요?
          </h2>
